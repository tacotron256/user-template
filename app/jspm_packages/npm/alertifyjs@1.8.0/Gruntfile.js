  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      uglify: {
        ...
        dist: {files: {'build/alertify.min.js': ['<banner>', 'build/alertify.js']}}
      },
      watch: {src: {
          files: ['src/**/*.js'],
          tasks: ['build']
      ...
      compress: {
        options: {archive: 'build/alertifyjs.zip'},
        build: {files: [{
            expand: true,
            cwd: 'build',
            src: ['**']
